...
echo "=== DRY-RUN TEST OF MATAAS_NA_LUPA_SET2_5_BENEFICIARIES.xlsx ===\n";

$superadmin = User::where('role', 'superadmin')->first();
$filePath = __DIR__ . '/../datasets/MATAAS_NA_LUPA_SET2_5_BENEFICIARIES.xlsx';
...
try {
    ...
    if (!empty($import->skipped)) {
        ...
        echo "✓ PERFECT! All 5 new Mataas na Lupa beneficiaries validated and imported with 0 errors/skips!\n";
    }
    ...
    // ALWAYS ROLLBACK to keep DB clean for user's actual import test
    DB::rollBack();
