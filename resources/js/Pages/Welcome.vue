      ...
      <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <template v-if="authUser">
            <Link :href="dashboardRoute" class="btn btn-primary btn-sm gap-1.5 shadow-xs">
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
          ...
          <div v-for="(step, i) in steps" :key="i" class="flex flex-col items-center text-center">
            ...
            <p class="text-xs text-slate-500 mt-1 leading-relaxed max-w-[170px]">{{ step.desc }}</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div class="card p-8 flex flex-col items-center text-center group hover:shadow-xl transition-shadow">
            ...
            <p class="text-sm text-slate-500 leading-relaxed mb-6">
              For DSWD personnel — administrators, SWA officers, 4Ps officers, and barangay assistants.
            </p>
            <template v-if="authUser && authUser.role !== 'beneficiary'">
